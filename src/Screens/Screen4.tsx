...
export const Screen4 = ({navigation}: Props) => {
  ...
  const Mayor = () => {
    ...
    setResult(`El mayor de los dos es: ${mayor}`);
  };

  return (
    <View style={styles.container2}>
      <TitleComponent title='Elegir el mayor'/>
      <Input valor={num1} onChangeTextHandler={setNum1} />
      <Input valor={num2} onChangeTextHandler={setNum2} />
      <ButtonComponent textButton='Mayor' onPress={Mayor}/>
